...
const active_user_decorator_1 = require("../common/enums/decorators/active-user.decorator");
...
let CatsController = class CatsController {
    ...
    create(createCatDto, user) {
        return this.catsService.create(createCatDto, user);
    }
    findOne(id, user) {
        return this.catsService.findOne(id, user);
    }
    update(id, updateCatDto, user) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_cat_dto_1.UpdateCatDto, Object]),
    __metadata("design:returntype", void 0)
